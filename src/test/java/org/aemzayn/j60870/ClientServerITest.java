...
import org.aemzayn.j60870.ie.IeBinaryCounterReading;
...
import org.aemzayn.j60870.ie.IeDoubleCommand.DoubleCommandState;
import org.aemzayn.j60870.ie.IeDoublePointWithQuality;
import org.aemzayn.j60870.ie.IeDoublePointWithQuality.DoublePointInformation;
import org.aemzayn.j60870.ie.IeNormalizedValue;
import org.aemzayn.j60870.ie.IeProtectionQuality;
import org.aemzayn.j60870.ie.IeProtectionStartEvent;
...
import org.aemzayn.j60870.ie.IeSinglePointWithQuality;
import org.aemzayn.j60870.ie.IeSingleProtectionEvent;
import org.aemzayn.j60870.ie.IeSingleProtectionEvent.EventState;
import org.aemzayn.j60870.ie.IeStatusAndStatusChanges;
import org.aemzayn.j60870.ie.IeTime16;
import org.aemzayn.j60870.ie.IeTime24;
import org.aemzayn.j60870.ie.IeTime56;
import org.aemzayn.j60870.ie.IeValueWithTransientState;
        ...
        public void testClientServerCom() throws Exception {
                ...
                try (Connection clientConnection = new ClientConnectionBuilder("127.0.0.1")
                        ...
                        clientConnection.singleCommand(Util.convertToCommonAddress(63, 203),
                                        CauseOfTransmission.ACTIVATION, 1,
                        ...
                        clientConnection.send(
                                        new ASdu(ASduType.M_SP_NA_1, false, CauseOfTransmission.SPONTANEOUS, false,
                                                        false, 0, commonAddress,
                ...
                public void newASdu(Connection connection, ASdu aSdu) {
                        ...
                        try {
                                ...
                                if (serverCounter == 1) {
                                        ...
                                        IeSingleCommand singleCommand = (IeSingleCommand) aSdu
                                                        .getInformationObjects()[0]
                                        ...
                                        connection.send(new ASdu(ASduType.C_SC_NA_1, false,
                                                        CauseOfTransmission.ACTIVATION_CON, false,
                                        ...
                                        aSdu = new ASdu(ASduType.C_CS_NA_1, false, CauseOfTransmission.ACTIVATION_CON,
                                                        false, false, 0,
                                                        aSdu.getCommonAddress(),
                                                        new InformationObject[] { new InformationObject(0,
                                                                        new InformationElement[][] { { new IeTime56(
                                                                                        serverTimestamp) } }) });
                                        ...
                                        IeDoubleCommand doubleCommand = (IeDoubleCommand) aSdu
                                                        .getInformationObjects()[0]
                                                        .getInformationElements()[0][0];
                                        assertEquals(DoubleCommandState.NOT_PERMITTED_A,
                                                        doubleCommand.getCommandState());
                                        assertTrue(doubleCommand.isSelect());
                                        assertEquals(3, doubleCommand.getQualifier());

                                        connection.send(new ASdu(ASduType.C_DC_TA_1, false,
                                                        CauseOfTransmission.ACTIVATION_CON, false,
                                        ...
                                        connection.send(new ASdu(ASduType.C_SE_NA_1, false,
                                                        CauseOfTransmission.ACTIVATION_CON, false,
                                                        false, 0, aSdu.getCommonAddress(),
                                                        aSdu.getInformationObjects()));
                                        ...
                                        connection.send(new ASdu(ASduType.C_IC_NA_1, false,
                                                        CauseOfTransmission.ACTIVATION_CON, false,
                                                        false, 0, aSdu.getCommonAddress(),
                                                        new InformationObject[] { new InformationObject(0,
                                                                        new InformationElement[][] { {
                                        ...
                                        connection.send(new ASdu(ASduType.M_SP_NA_1, false,
                                                        CauseOfTransmission.SPONTANEOUS, false, false,
                                        ...
                                        connection
                                                        .send(new ASdu(ASduType.M_SP_NA_1, true,
                                                                        CauseOfTransmission.SPONTANEOUS, false, false,
                                                                        0,
                                                                        aSdu.getCommonAddress(),
                                                                        new InformationObject[] { new InformationObject(
                                                                                        1, new InformationElement[][] {
                                                                                                        { new IeSinglePointWithQuality(
                                                                                                                        true,
                                                                                                                        true,
                                                                                                                        true,
                                        ...
                                        connection.send(new ASdu(ASduType.M_SP_TA_1, false,
                                                        CauseOfTransmission.SPONTANEOUS, false, false,
                                                        0, aSdu.getCommonAddress(),
                                                        new InformationObject[] {
                                                                        new InformationObject(1,
                                        ...
                                        connection.send(new ASdu(ASduType.M_DP_NA_1, false,
                                                        CauseOfTransmission.SPONTANEOUS, false, false,
                                                        0, aSdu.getCommonAddress(),
                                        ...
                                        connection.send(new ASdu(ASduType.M_ST_NA_1, true,
                                        ...
                                        connection.send(new ASdu(ASduType.M_BO_NA_1, true,
                                                        CauseOfTransmission.SPONTANEOUS, false, false, 0,
                                                        aSdu.getCommonAddress(),
                                                        new InformationObject[] { new InformationObject(1,
                                                                        new InformationElement[][] {
                                        ...
                                        connection.send(new ASdu(ASduType.M_ME_NA_1, true,
                                                        CauseOfTransmission.SPONTANEOUS, false, false, 0,
                                                        aSdu.getCommonAddress(),
                                                        new InformationObject[] { new InformationObject(1,
                                                                        new InformationElement[][] {
                                        ...
                                        connection.send(new ASdu(ASduType.M_ME_NC_1, true,
                                                        CauseOfTransmission.SPONTANEOUS, false, false, 0,
                                                        aSdu.getCommonAddress(),
                                                        new InformationObject[] { new InformationObject(1,
                                                                        new InformationElement[][] {
                                                                                        { new IeShortFloat(-32768.2f),
                                                                                                        new IeQuality(true,
                                                                                                                        true,
                                                                                                                        true,
                                                                                                                        true,
                                        ...
                                        connection.send(new ASdu(ASduType.M_IT_NA_1, true,
                                                        CauseOfTransmission.SPONTANEOUS, false, false, 0,
                                                        aSdu.getCommonAddress(),
                                                        new InformationObject[] { new InformationObject(1,
                                                                        new InformationElement[][] {
                                        ...
                                        connection.send(new ASdu(ASduType.M_EP_TA_1, false,
                                                        CauseOfTransmission.SPONTANEOUS, false, false,
                                                        0, aSdu.getCommonAddress(),
                                                        new InformationObject[] {
                                                                        new InformationObject(1,
                                        ...
                                        connection.send(new ASdu(ASduType.M_EP_TB_1, false,
                                                        CauseOfTransmission.SPONTANEOUS, false, false,
                                                        0, aSdu.getCommonAddress(),
                                                        new InformationObject[] { new InformationObject(1,
                                                                        new InformationElement[][] {
                                        ...
                                        connection.send(new ASdu(ASduType.M_PS_NA_1, false,
                                                        CauseOfTransmission.SPONTANEOUS, false, false,
                                                        0, aSdu.getCommonAddress(),
                                                        new InformationObject[] { new InformationObject(1,
                                                                        new InformationElement[][] { {
                                        ...
                                        connection.send(new ASdu(ASduType.M_ME_ND_1, false,
                                                        CauseOfTransmission.SPONTANEOUS, false, false,
                                                        0, aSdu.getCommonAddress(),
                                                        new InformationObject[] { new InformationObject(1,
                                                                        new InformationElement[][] {
                                        ...
                                        connection
                                                        .send(new ASdu(ASduType.M_SP_TB_1, false,
                                                                        CauseOfTransmission.SPONTANEOUS, false, false,
                                                                        0,
                                                                        aSdu.getCommonAddress(),
                                                                        new InformationObject[] {
                                        ...
                                        connection
                                                        .send(new ASdu(ASduType.M_IT_TB_1, false,
                                                                        CauseOfTransmission.SPONTANEOUS, false, false,
                                                                        0,
                                                                        aSdu.getCommonAddress(),
                                                                        new InformationObject[] { new InformationObject(
                                        ...
                                        connection.send(new ASdu(ASduType.PRIVATE_136, false, 1,
                ...
                public void newASdu(Connection connection, ASdu aSdu) {
                        ...
                        try {
                                ...
                                if (counter == 1) {
                                        ...
                                        IeSinglePointWithQuality io2 = (IeSinglePointWithQuality) aSdu
                                                        .getInformationObjects()[1]
                                                        .getInformationElements()[0][0];
                                        ...
                                        IeSinglePointWithQuality pointWithQuality = (IeSinglePointWithQuality) aSdu
                                                        .getInformationObjects()[0].getInformationElements()[0][0];
                                        IeTime24 time24 = (IeTime24) aSdu.getInformationObjects()[0]
                                        ...
                                        assertSame(doublePointWithQuality.getDoublePointInformation(),
                                                        DoublePointInformation.OFF);
                                        ...
                                        IeNormalizedValue normalizedValue = (IeNormalizedValue) aSdu
                                                        .getInformationObjects()[0]
                                                        .getInformationElements()[0][0];

                                        assertEquals(-32768, normalizedValue.getUnnormalizedValue());

                                        IeNormalizedValue normalizedValue2 = (IeNormalizedValue) aSdu
                                                        .getInformationObjects()[0]
                                                        .getInformationElements()[1][0];
                                        ...
                                        IeTime16 time16 = (IeTime16) aSdu.getInformationObjects()[0]
                                                        .getInformationElements()[0][1];
                                        assertEquals(300, time16.getTimeInMs());

                                        IeTime24 time24 = (IeTime24) aSdu.getInformationObjects()[0]
                                                        .getInformationElements()[0][2];
                                        ...
                                        IeProtectionQuality protectionQuality = (IeProtectionQuality) aSdu
                                                        .getInformationObjects()[0]
                                                        .getInformationElements()[0][1];
                                        ...
                                        IeTime56 time56 = (IeTime56) aSdu.getInformationObjects()[0]
                                                        .getInformationElements()[0][1];
