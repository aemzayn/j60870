...
public class Server {
     ...
     *
     * @param listener
     *                 the ServerConnectionListener that will be notified when
     *                 remote clients are connecting or the server
     *                 stopped listening.
     * @throws IOException
     *                     if any kind of error occurs while creating the server
     *                     socket.
     */
    ...
    public static class Builder extends CommonBuilder<Builder, Server> {
        ...
        /**
         * Sets the TCP port that the server will listen on. IEC 60870-5-104 usually
         * uses port 2404.
         *
         * @param port
         *             the port
        ...
        /**
         * Sets the ServerSocketFactory to be used to create the ServerSocket. Default
         * is
         * ServerSocketFactory.getDefault().
         *
         * @param socketFactory
         *                      the ServerSocketFactory to be used to create the
         *                      ServerSocket
         * @return this builder
         */
        ...
        /**
         * Set the IPs from which clients may connect. Pass {@code null} to allow all
         * clients. By default all clients
        ...
        /**
         * To start/activate the server call {@link Server#start(ServerEventListener)}
