...
/**
 * Every ASDU contains a type identification field that defines the purpose and
 * contents of the ASDU. Every Type
 * Identifier is of the form A_BB_CC_1 with the following meanings:
 * 
 * <ul>
 * 
 * <li>A - can be 'M' for information in monitor direction, 'C' for system
 * information in control direction, 'P' for
 * parameter in control direction or 'F' for file transfer.</li>
 * 
 * <li>BB - a two letter abbreviation of the function of the message (e.g. "SC"
 * for Single Command)</li>
 * 
 * <li>CC - additional information to distinguish different messages with the
 * same function (e.g. "NA" for no timestamp
...
public enum ASduType {
    ...
    /**
     * 63 - C_SE_TC_1 Set-point command with time tag CP56Time2a, short floating
     * point number
     */
    ...
    /**
     * Returns the ASduType that corresponds to the given ID. Returns
     * <code>null</code> if no ASduType with the given ID
     * exists.
     * 
     * @param id
     *           the ID
