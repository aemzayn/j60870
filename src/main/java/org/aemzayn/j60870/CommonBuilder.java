...
abstract class CommonBuilder<T extends CommonBuilder<T, C>, C> {
    ...
    /**
     * Sets the length of the Information Object Address (IOA) field of the
     * ASDU.<br>
    ...
    /**
     * Sets the maximum time in ms that no acknowledgement has been received (for
     * I-Frames or Test-Frames) before
     * actively closing the connection. This timeout is called t1 by the
     * standard.<br>
     * Default is 15s, minimum is 1s, maximum is 255s.<br>
     * t1 (maxTimeNoAckReceived) has to be greater then t2 (maxTimeNoAckSent) and t1
     * has to be smaller then t3
     * (maxIdleTime) (t1 &gt; t2 and t1 &lt; t3)
     *
     * @param time_t1
     *                the maximum time in ms that no acknowledgement has been
     *                received before actively closing the
     *                connection.
     * @return this builder
     */
    ...
    /**
     * Sets the maximum time in ms before confirming received messages that have not
     * yet been acknowledged using an S
     * format APDU. This timeout is called t2 by the standard.<br>
     * Default is 10s, minimum is 1s, maximum is 255s.<br>
     * t2 (maxTimeNoAckSent) has to be smaller then t1 (maxTimeNoAckReceived), t3
     * &gt; t1.
     *
     * @param time_t2
     *                the maximum time in ms before confirming received messages
     *                that have not yet been acknowledged using
     *                an S format APDU.
     * @return this builder
     */
    ...
    /**
     * Sets the maximum time in ms that the connection may be idle before sending a
     * test frame. This timeout is called
     ...
     *
     * @param time_t3
     *                the maximum time in ms that the connection may be idle before
    ...
    /**
     * Sets the number of maximum difference send sequence number to send
     * acknowledge variable before Connection.send
     * will block. This parameter is called k by the standard.<br>
     * Default is 12, minimum is 1, maximum is 32767.
     *
     * @param maxNum
     *               the maximum number of sequentially numbered I format APDUs that
     *               the DTE may have outstanding
     * @return this builder
     */
    ...
    /**
     * Sets the number of unacknowledged I format APDUs received before the
     * connection will automatically send an S
     * format APDU to confirm them. This parameter is called w by the standard.
     * Default is 8, minimum is 1, maximum is
     * 32767.
     *
     * @param maxNum
     *               the number of unacknowledged I format APDUs received before the
     *               connection will automatically send an
