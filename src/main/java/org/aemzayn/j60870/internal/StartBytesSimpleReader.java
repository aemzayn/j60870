 ...
 *
 */
package org.aemzayn.j60870.internal;
...
public final class StartBytesSimpleReader {
    ...
    /**
     * Reads from the input stream until the start bytes are received. The start
     * bytes are put in the
     * {@code destBuffer}. Any bytes that do not match the start byte sequence are
     * discarded. If reading from the input
