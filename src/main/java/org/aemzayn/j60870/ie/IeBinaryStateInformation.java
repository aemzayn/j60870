...
public class IeBinaryStateInformation extends InformationElement {
    ...
    /**
     * Creates a BSI (binary state information) information element from an integer
     * value.
     * 
     * @param value
     *              the bits of value represent the 32 binary states of this
     *              element. When encoded in a message, the MSB
     *              of <code>value</code> is transmitted first and the LSB of
     *              <code>value</code> is transmitted last.
     */
    ...
    /**
     * Creates a BSI (binary state information) information element from a byte
     * array.
     * 
     * @param value
     *              the bits of value represent the 32 binary states of this
     *              element. When encoded in a message, the MSB
     *              of the first byte is transmitted first and the LSB of fourth
     *              byte is transmitted last.
     */
    ...
    /**
     * Returns the 32 binary states of this element as an integer. When encoded in a
     * message, the MSB of the return
     * value is transmitted first and the LSB of the return value is transmitted
     * last.
     * 
    ...
    /**
     * Returns the 32 binary states of this element as a byte array. When encoded in
     * a message, the MSB of the first
     ...
     * 
     * @param position
     *                 the position in the bit string. Range: 1-32. Position 1
     *                 represents the last bit in the encoded message
     *                 and is the least significant bit (LSB) of the value returned
     *                 by <code>getValue()</code>. Position 32
     *                 represents the first bit in the encoded message and is the
     *                 most significant bit (MSB) of the value
