 ...
 * <li>A set of Information Elements or a sequence of information element sets.
 * The type of information elements in the
 * set and their order depend on the ASDU's TypeId and is the same for all
 * information objects within one ASDU. If the
 * sequence bit is set in the ASDU then the ASDU contains a single Information
 * Object containing a sequence of
 * information element sets. If the sequence bit is not set the ASDU contains a
 * sequence of information objects each
...
public class InformationObject {
        ...
        switch (aSduType) {
            ...
            case M_SP_TA_1:
                informationElements = new InformationElement[][] {
                        { new IeSinglePointWithQuality(is), new IeTime24(is) } };
                break;
            // 3
            case M_DP_NA_1:
                informationElements = new InformationElement[numberOfSequenceElements][1];
            ...
            case M_DP_TA_1:
                informationElements = new InformationElement[][] {
                        { new IeDoublePointWithQuality(is), new IeTime24(is) } };
                break;
            // 5
            case M_ST_NA_1:
            ...
            case F_FR_NA_1:
                informationElements = new InformationElement[][] {
                        { IeNameOfFile.decode(is), IeLengthOfFileOrSection.decode(is),
                                IeFileReadyQualifier.decode(is) } };
                break;
            // 121
            case F_SR_NA_1:
                informationElements = new InformationElement[][] {
                        { IeNameOfFile.decode(is), IeNameOfSection.decode(is),
            ...
            // 123
            case F_LS_NA_1:
                return new InformationObject(informationObjectAddress, IeNameOfFile.decode(is),
                        IeNameOfSection.decode(is),
    ...
    /**
     * Returns the information elements as a two dimensional array. The first
     * dimension of the array is the index of the
     * sequence of information element sets. The second dimension is the index of
     * the information element set. For
     * example an information object containing a single set of three information
     * elements will have the dimension
     * [1][3]. Note that you will have to cast the returned
     * <code>InformationElement</code>s to a concrete
