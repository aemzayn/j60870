...
public class IeStatusAndStatusChanges extends InformationElement {
     ...
     * 
     * @param value
     *              the bits of value represent the status and status changed bits.
     *              Bit1 (the least significant bit) of
     *              value represents the first status changed detection bit. Bit17
     *              of value represents the first status
     *              bit.
     */
    ...
    /**
     * Returns true if the status at the given position is ON(1) and false
     * otherwise.
     * 
     * @param position
     *                 the position in the status bitstring. Range: 1-16. Status 1
     *                 is bit 17 and status 16 is bit 32 of the
     *                 value returned by <code>getValue()</code>.
     * @return true if the status at the given position is ON(1) and false
     *         otherwise.
     */
    ...
    /**
     * Returns true if the status at the given position has changed and false
     * otherwise.
     * 
     * @param position
     *                 the position in the status changed bitstring. Range: 1-16.
     *                 Status changed 1 is bit 1 and status 16 is
     *                 bit 16 of the value returned by <code>getValue()</code>.
     * @return true if the status at the given position has changed and false
     *         otherwise.
     */
