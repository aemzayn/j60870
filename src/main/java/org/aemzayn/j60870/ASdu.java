 ...
 * application protocol data unit (APDU). Its
 * structure is defined in IEC 60870-5-101. The ASDU consists of the Data Unit
 * Identifier and a number of Information
 ...
 * originating controlling station so that
 * responses can be routed back to it.</li>
 * <li>Common Address of ASDU (1 or 2 bytes) - the address of the target station
 * or the broadcast address. If the field
 * length of the common address is 1 byte then the addresses 1 to 254 are used
 * to address a particular station (station
 * address) and 255 is used for broadcast addressing. If the field length of the
 * common address is 2 bytes then the
 * addresses 1 to 65534 are used to address a particular station and 65535 is
 * used for broadcast addressing. Broadcast
 * addressing is only allowed for certain TypeIDs.</li>
 * <li>A list of Information Objects containing the actual actual data in the
 * form of Information Elements.</li>
 * </ul>
 */
public class ASdu {
     ...
     *
     * @param typeId
     *                             type identification field that defines the
     *                             purpose and contents of the ASDU
     * @param isSequenceOfElements
     *                             if {@code false} then the ASDU contains a
     *                             sequence of information objects consisting of a
     *                             fixed number
     *                             of information elements. If {@code true} the ASDU
     *                             contains a single information object with a
     *                             sequence
     *                             of elements.
     ...
     *                             the address of the originating controlling
     *                             station so that responses can be routed back to
     *                             it
     * @param commonAddress
     *                             the address of the target station or the
     *                             broadcast address.
     * @param informationObjects
     *                             the information objects containing the actual
     *                             data
     */
    ...
    /**
     * Use this constructor to create private ASDU with TypeIDs in the range
     * 128-255.
     *
     * @param typeId
     *                             type identification field that defines the
     *                             purpose and contents of the ASDU
     * @param isSequenceOfElements
     *                             if false then the ASDU contains a sequence of
     *                             information objects consisting of a fixed number
     *                             of
     *                             information elements. If true the ASDU contains a
     *                             single information object with a sequence of
     *                             elements.
     * @param sequenceLength
     *                             the number of information objects or the number
     *                             elements depending on which is transmitted as a
     *                             sequence
     * @param causeOfTransmission
     *                             the cause of transmission
     * @param test
