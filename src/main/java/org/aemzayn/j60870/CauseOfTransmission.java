...
/**
 * Every ASDU contains a single Cause Of Transmission field so the recipient
 * knows why the message it received was sent.
 * Parts IEC 60870-5-101 and IEC 60870-5-104 define what CauseOfTransmissions
 * are allowed for the different ASDU types.
 * CauseOfTransmissions 44 to 47 are meant for replies to commands with
 * undefined values.
 */
public enum CauseOfTransmission {
    ...
    /**
     * Returns the CauseOfTransmission that corresponds to the given ID. Returns
